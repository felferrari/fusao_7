...
from ops.dataloader import get_train_val_dataset, data_augmentation, prep_data
...
for model_idx in range(n_train_models):
    model = late_fusion_resunet(shape_opt, shape_sar, model_size, n_classes, reg_weight = None, name = 'late_fusion')
