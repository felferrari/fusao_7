...
from models.models import late_fusion_resunet_previous
from ops.ops import load_json
import os
from models.losses import WBCE
from ops.dataloader_pm import get_train_val_dataset, data_augmentation, prep_data

exp_path = load_json(os.path.join('conf', 'exps', f'exp_late_fusion.json'))
...
for model_idx in range(n_train_models):
    model = late_fusion_resunet_previous(shape_opt, shape_sar, shape_previous, model_size, n_classes, reg_weight = None, name = 'late_fusion')
