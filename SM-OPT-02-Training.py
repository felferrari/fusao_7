...
from ops.dataloader import get_train_val_dataset, data_augmentation, prep_data_opt
...
for model_idx in range(n_train_models):
    model = sm_resunet(shape_opt, model_size, n_classes, reg_weight = None, name = 'sm_opt')
