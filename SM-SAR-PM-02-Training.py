...
from ops.dataloader_pm import get_train_val_dataset, data_augmentation, prep_data_sar
...
for model_idx in range(n_train_models):
    model = sm_resunet_pm(shape_sar, shape_previous, model_size, n_classes, reg_weight = None, name = exp_name)
